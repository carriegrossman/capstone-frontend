            ...
            <div className="verificationCode">
                <form>
                    ...
                    <div className="control">
                            <input className="input" type="password" placeholder="Enter code from email" name="verificationCode" id="verificationCode" onChange={handleChange} required />
                        </div>
                    </label>
                    <Link className="button is-warning"to="/registershop">Submit</Link>
