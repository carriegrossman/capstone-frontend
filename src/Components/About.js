...
export default function About() {
    ...
    <div>
      <section className="about">
        ...
        <p>
          ...
          Brewsy we like big cups and we cannot lie.</p>
          <br></br>
  ...
  <div className="tile is-parent">
    <article className="tile is-child box">
      ...
      <p className="subtitle">My Favorite Coffee Drink is... Caramel Macchiato</p>
      <div className="content">
        ...
        <p className='github'><a href="https://github.com/carriegrossman">GitHub</a> | <a href="https://www.linkedin.com/in/carriegrossman/">LinkedIn</a></p>
      </div>
    </article>
  </div>
  <div className="tile is-parent">
    <article className="tile is-child box">
      ...
      <p className="subtitle">My Favorite Coffee Drink is... Pumpkin Cold Brew</p>
      <div className="content">
      <figure className="image">
        ...
        <p className='github'><a href="https://github.com/GarciaFrida">GitHub</a> | <a href="www.linkedin.com/in/Fgarcia3">LinkedIn</a></p>
      </div>
    </article>
  </div>
  <div className="tile is-parent">
    <article className="tile is-child box">
      ...
      <p className="subtitle"> My Favorite Coffee Drink is... Spicy Tumeric Latte</p>
      <div className="content">
      <figure className="image">
        ...
        <p className='github'><a href="https://github.com/pfarrell18">GitHub</a> | <a href="https://www.linkedin.com/in/priyanka-farrell-277273110/">LinkedIn</a></p>
      </div>
    </article>
  </div>
</div>
